...
def build_parser() -> argparse.ArgumentParser:
    ...
    s.add_argument("--sheet",
                   help="hierarchical sheet to render (name or substring); "
                        "default is the root sheet, which on a hierarchical "
                        "design is usually just boxes")
    s.add_argument("--all", action="store_true",
                   help="render every sheet, to <out>-<sheetname>.png")
    s.add_argument("--region", help="zoom to x,y,w,h in sheet mm (y grows down)")
